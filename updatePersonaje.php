...
if(isset($parameters)){
	...
	if(JSONCorrectoUpdate($mensajeRecibido)){

		$personaje = $mensajeRecibido["personajeUpdate"];
		...
		$query  = "	UPDATE `personajes` SET Nombre_Personaje='$nombre',ID_Juego='$id_juego' WHERE ID='$id'";
